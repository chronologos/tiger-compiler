...
|  ( 70, ( ( _, ( MlyValue.varDecOpt varDecOpt1, _, varDecOpt1right))
 ...
 in (
{name = S.symbol(ID), escape = ref true, typ = #typ varDecOpt, init = #init varDecOpt, pos = VARleft}
)
end)
...
|  ( 75, ( ( _, ( MlyValue.fundecOpts fundecOpts1, _, fundecOpts1right
...
MlyValue.ID ID1, _, _)) :: ( _, ( _, (FUNCTIONleft as FUNCTION1left),
 ...
 in (
{name= S.symbol(ID), params=tyfields, result = #result fundecOpts, body = #body fundecOpts, pos = FUNCTIONleft}
)
end)
